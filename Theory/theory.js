...
What is node.js?
>> open-source (Nodejs has a huge community of collaborators who works consistently to provide new features and keeps it up to date)
>> cross-platform (Can run on any operating system like; windows, linux, or mac)
>> Javascript runtime enviroment that lets developer write command line tools and servers-de scripts outside of browser. It's build of
    Google Chrome's V8 engine which allows javascript to run outside of browser
